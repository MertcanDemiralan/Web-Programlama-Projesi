...
namespace WebProgramlamaProjesi.Controllers
{
    public class KullanicisController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Adi,Soyadi,Email,Sifre,Sifre_Tekrar,Telefon")] Kullanici kullanici)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Adi,Soyadi,Email,Sifre,Sifre_Tekrar,Telefon")] Kullanici kullanici)
        {
            if (id != kullanici.Id)
            {
                return NotFound();
