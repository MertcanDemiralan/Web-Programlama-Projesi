...
{
    public partial class FilmlerEklendi : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Film_URL = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Film_Kategorileri = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
