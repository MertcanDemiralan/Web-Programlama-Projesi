...
namespace WebProje.Controllers
{
    public class FilmsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FilmId,Film_Adi,Film_Aciklamasi")] Film film)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FilmId,Film_Adi,Film_Aciklamasi")] Film film)
        {
            if (id != film.FilmId)
            {
                return NotFound();
