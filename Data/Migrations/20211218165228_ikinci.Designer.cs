...
namespace WebProgramlamaProjesi.Data.Migrations
{
    ...
    [Migration("20211218165228_ikinci")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FilmKategori", b =>
                {
                    ...
                    b.HasKey("FilmlerFilmId", "KategorilerId");
            ...
            modelBuilder.Entity("WebProgramlamaProjesi.Models.Admin", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebProgramlamaProjesi.Models.Film", b =>
                {
            ...
            modelBuilder.Entity("WebProgramlamaProjesi.Models.Kategori", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebProgramlamaProjesi.Models.Kullanici", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebProgramlamaProjesi.Models.Oyuncu", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FilmKategori", b =>
                {
                    b.HasOne("WebProgramlamaProjesi.Models.Film", null)
                        .WithMany()
                        .HasForeignKey("FilmlerFilmId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebProgramlamaProjesi.Models.Kategori", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WebProgramlamaProjesi.Models.Film", b =>
                {
                    b.HasOne("WebProgramlamaProjesi.Models.Kullanici", null)
                        .WithMany("Favoriler")
