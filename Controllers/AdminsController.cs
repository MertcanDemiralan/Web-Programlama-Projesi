...
namespace WebProje.Controllers
{
    public class AdminsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Adi,Soyadi,Email,Sifre,Sifre_Tekrar,Telefon")] Admin admin)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Adi,Soyadi,Email,Sifre,Sifre_Tekrar,Telefon")] Admin admin)
        {
            if (id != admin.Id)
            {
                return NotFound();
